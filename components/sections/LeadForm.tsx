  ...
  return (
    ...
    >
      <div className="lead-form__header">
        ...
        <p>Comparta sus datos y coordinaremos una visita a la sala de ventas o el envío del dossier completo.</p>
      </div>
      ...
      <div className="lead-form__fields">
        ...
        <label>
          ...
          <select name="interes" defaultValue="dossier">
      ...
      <label className="lead-form__consent">
        <input name="autorizacion" type="checkbox" required />
        <span>Autorizo que el equipo comercial de Altum San Isidro se comunique conmigo respecto al proyecto.</span>
      </label>

      <button type="submit" className="lead-form__submit">Solicitar información</button>
      <p className="lead-form__note">Al enviar, se abrirá su aplicación de correo con la solicitud preparada.</p>
    </form>
  );
}
