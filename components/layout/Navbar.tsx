...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <nav
          className="minimal-nav__links minimal-nav__links--left"
          aria-label="Recorrido principal"
        >
          {renderInlineLinks(NAVIGATION.left)}
        </nav>
        ...
        >
          <small>Residencias privadas</small>
        ...
        <div className="minimal-nav__right">
          <nav
            className="minimal-nav__links"
            aria-label="Información del proyecto"
          >
            {renderInlineLinks(NAVIGATION.right)}
          </nav>
      ...
      {isMenuOpen ? (
        ...
        >
          ...
          <div className="site-index__layout">
            <nav aria-label="Índice principal">
            ...
            <aside>
              ...
              <p>
                Doce residencias privadas en
                San Isidro, concebidas para
                una vida de mayor calma y
                privacidad.
              </p>
